...
<div class="col-md-12">
	...
	if (!empty($_POST['form-order'])) {
		...
		if ($difference->days >= 0) {
			...
			$q = mysql_query("insert into pesanan Values(NULL,'$tanggal_pesan','$tanggal_digunakan','$_SESSION[iam_user]','$nama','$telephone','$alamat','0','belum diambil')");
			if ($q) {
	...
	<div class="row">
		...
		<div class="col-md-7">
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<label>Waktu Pengambilan barang</label><br>
